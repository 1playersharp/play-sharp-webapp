...
const PLANS = [
    {
        ...
        features: [
            "Limited reaction drill",
            "Limited decision drill",
    ...
    },
    {
        ...
        price: "£££",
        period: "/month",
        tagline: "For individual player-models.",
        features: [
            "Full reaction speed drills",
            "Scanning ability training",
            "Decision-making under pressure",
            "PlaySharp IQ scoring",
            "Individual player leaderboard access",
    ...
    },
    {
        ...
        features: [
            ...
            "Personalised Team training insights",
            "Team leaderboard & challenges",
            "Up to 25 player-models per team",
        ],
        coming: "AI Coaching",
        cta: "Contact Sales",
        href: "/contact",
    ...
    },
    {
        ...
        price: "Contact",
        period: "for price",
        tagline: "For professional academies.",
        features: [
            "Everything in Team",
